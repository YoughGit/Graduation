...
jQuery.fn.extend({
	...
	function style(){
		...
		var Page_Son=".pa1 "+page_+"{transition: all 0.30s ease-in-out;-webkit-transition: all 0.30s ease-in-out;-moz-transition: all 0.30s ease-in-out;-o-transition: all 0.30s ease-in-out;-ms-transition: all 0.30s ease-in-out;display:inline;list-style-type:none;padding: 6px 12px;cursor: pointer;border: #000 1px solid;border-radius:50%;background-color: #fff;color: #000;margin: 2px;}.pa1 "+page_+":hover{background-color:#4b9eb3; color:#fff;}";
		var Page_click=".page-click{background-color: #4b9eb3!important;color: #fff!important;font-weight: bold!important;}.page-click:hover{background-color:#4b9eb3!important;color: #fff!important;}";
